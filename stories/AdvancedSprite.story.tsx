...
import sprite from '../statics/CSV_Export_Sprite.png';

const WIDTH = 300;
const HEIGHT = 150;
const enum ANIMATION_TYPES {
  EXPORT = 'export',
  ERROR = 'error',
  SUCCESS = 'success',
}
...
type AdvancedSpriteStoryState = {
  ...
  updateTo: ANIMATION_TYPES | null;
};

class AdvancedSpriteStory extends React.Component<
  {},
  AdvancedSpriteStoryState
> {
  state = {
      ...
      >
        ...
        >
          <span style={{ marginBottom: 6 }}>
            <Button
              height="small"
              onClick={this._onError}
              disabled={type !== ANIMATION_TYPES.EXPORT}
            >
              Error
            </Button>
          </span>
...
export const Advanced = () => <AdvancedSpriteStory />;
